...
const Skills = () => {
  return (
    <section id="skills" className="py-16 mb-20 md:h-screen">
      <div className="container mx-auto">
        ...
        <div className="grid grid-cols-1 mx-6 md:grid-cols-2 lg:grid-cols-4 gap-8">
          {skills.map((skill, index) => (
            <motion.div
              key={index}
              className="bg-white p-8 rounded-xl shadow-lg hover:shadow-2xl transition-shadow duration-300 text-center transform hover:-translate-y-2"
